...
namespace Soccer.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public PlayersController(SoccerContext context, IWebHostEnvironment appEnvironment)
        {
            _context = context;
            _appEnvironment = _appEnvironment;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,Position,NameFile,TeamId")] Players players, IFormFile uploadedFile)
        {
            try
            {
                ...
                //    }
                //    players.PathToFile = path;
                //}

                Console.WriteLine("==============");
                Console.WriteLine($"Name {players.Name}");
                Console.WriteLine($"Age {players.Age}");
                Console.WriteLine($"Position {players.Position}");
                Console.WriteLine($"NameFile {players.NameFile}");
                Console.WriteLine($"PathToFile {players.PathToFile}");
